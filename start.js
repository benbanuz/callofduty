...
class Router {
  ...
  routeToNewDutie(data) {
    dutieDb.newDutie(data);
  }

  routeToGetDutie(name, id) {
    dutieDb.getDutie(name, id);
  }

  routeToDeleteDutie(id) {
    dutieDb.deleteDutie(id);
  }

  routeToUpdateDutie(data, id) {
    dutieDb.updateDutie(data, id);
  }

  routeToScheduleDutie(id) {
    dutieDb.scheduleDutie(id);
  }
...
function runServer(callback) {
  MongoClient.connect(mongoUrl, function (err, client) {
    ...
    module.exports.dutiesCollection = db.collection("duties");
